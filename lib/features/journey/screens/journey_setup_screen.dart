      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const SizedBox(height: 4),
            Text(
              '${_radiusMeters.round()} meters before destination',
            ...
            Row(
              ...
              children: const [Text('100 m'), Text('2 km')],
            ),
            const SizedBox(height: 20),
            Card(
              elevation: 0,
              child: ListTile(
                ...
                subtitle: Text(
                  _earliestArrival == null
                      ? 'No time constraint'
                      : '${_earliestArrival!.day}/${_earliestArrival!.month} • ${TimeOfDay.fromDateTime(_earliestArrival!).format(context)}',
                ),
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text(
                            'The app keeps monitoring your location in the background so you can travel without watching the map.',
                          ),
                        ],
                      ),
                    ),
